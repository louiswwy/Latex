...
En coupant $C-1$ arêtes la plus grande, nous pouvons grouper les données en $C$ parties\ref{fig:mstc}.
\begin{figure}[H]
\centering
...
L'algorithme KmMST peut être décri comme suit:
...
\subsubsection{La Règle d'association}
